...
export const NotRepoOrCommentNumber = '喵呜~ 仓库或拉取请求评论编号不能为空'
export const NotCommentBodyMsg = '喵呜~ 评论内容不能为空'
...
export const MissingBaseMsg = '喵呜~ 请提供目标分支'
...
export const NotUserNameParamMsg = '喵呜~ 用户名不能为空'
...
export const isNotIssucLockMsg = '喵呜~ 这个议题锁定失败哦'
export const isNotIssueCommentCreateMsg = '喵呜~ 这个议题评论创建失败哦'
export const isNotUnLockIssueMsg = '喵呜~ 这个议题解锁失败哦'
export const isNotDeleteReleaseMsg = '喵呜~ 这个发行版本删除失败哦'
...
export const NotReleaseMsg = '喵呜~ 这个发布不存在哦'
export const NotReleaseOrRepoMsg = '喵呜~ 这个发布或仓库不存在哦'
export const AppRepoMovedMsg = '喵呜~ 这个仓库已被移动'
